 ...
 * 		If at the end robot ���� is 180deg from origin angle, the next move will cause displacement of (-3, -5)
 * 		
 * 		If at the end robot ���� is 90deg from origin angle (turned left or right), the next move will cause displacement of
 * 		(3, -5) or (-3, 5)
 * 
 * 		To easier visualize this, we could further split it down into the 1D dimension, let's say X axis
 * 
 * 		Say x displacement is 5. At the end, robot will be facing ���� of 90deg.
 * 
...
public class $1041_Robot_Bounded_In_Circle {
