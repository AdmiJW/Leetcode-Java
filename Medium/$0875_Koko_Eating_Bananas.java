...
public class $0875_Koko_Eating_Bananas {
	...
	public int minEatingSpeed(int[] piles, int h) {
		...
		while (l < r) {
			int m = l + (r - l) / 2;		// mid value as k value
			int sum = 0;
			...
			if (sum > h) l = m + 1;		// Exceed hours. We need to increase eating rate
			else r = m;					// Workable hour. We can be greedy and try lower rate.
		}
