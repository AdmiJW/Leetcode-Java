...
public class $0845_Longest_Mountain_In_Array {
	...
	public int longestMountain(int[] A) {
        ...
        boolean isFalling = true;	//	Indicates the state we are in. Initially we assume we just falled
	...
	public int longestMountain2( int[] A ) {
		...
		while (base < size) {
			...
			res = Math.max( climber - base + 1, res);
			base = climber;
		}
		return res;
	}
